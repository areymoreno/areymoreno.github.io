var app = (function () {
  ...
  function kn(t) {
    ...
    return {
      c() {
        (n = w("div")),
        (n.textContent = "Juega a diario y comparte tu puntuación con tus amigos."),
      ...
      subscribe: ue(
        [
          ...
          */
          ...
          // Day 13: Ghost of Tsushima
          {
            url: "https://soundcloud.com/mc-moi-mcmoi/ghost-of-tsushima-ost-for-yarikawa-theme-ghost-stance-massacre-music-5-minute-extended",
            answer: "Ghost of Tsushima",
            song: "For Yarikawa Extended Theme"
          },
